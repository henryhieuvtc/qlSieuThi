...
namespace qlSieuThi
{
    ...
    public sealed partial class BanHang : Page
    {
        ...
        private void SplitViewButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            //this.MainFrame.Navigate(typeof(PageMOI))
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            d.Title = "==";
            d.Content = "Không có hoạt động nào";
            d.PrimaryButtonText = "Tiếp tục";
            await d.ShowAsync();
        }
        ...
        private void Addhoadon_Click(object sender, RoutedEventArgs e)
        {
            if (PPAddhoadonIsOpen)
            {
                PPAddhoadon.IsOpen = false;
                PPAddhoadonIsOpen = false;
            }
            else
            {
                dsHoaDon.Height = Window.Current.Bounds.Height - 350;
                PPAddhoadon.IsOpen = true;
                if (SplitView.IsPaneOpen)
                {
                    dsHoaDon.Width = Window.Current.Bounds.Width - 220;
                }
                ...
                PPAddhoadonIsOpen = true;
                PPTraThongTin.IsOpen = false;
                PPTraThongTinIsOpen = false;
        ...
        private void TraThongTin_Click(object sender, RoutedEventArgs e)
        {
            if (PPTraThongTinIsOpen)
            {
                PPTraThongTin.IsOpen = false;
                PPTraThongTinIsOpen = false;
            }
            ...
            {
                PPTraThongTin.IsOpen = true;
                PPTraThongTinIsOpen = true;
                PPAddhoadon.IsOpen = false;
                PPAddhoadonIsOpen = false;
                PPGuiYeuCau.IsOpen = false;
                PPGuiyeucauIsOpen = false;
